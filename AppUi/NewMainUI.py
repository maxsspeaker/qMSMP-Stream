...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow,workingDir,AccentColor=(183,46,43),NormalColor=(16,16,16),reloadView=True):
        
        if not(reloadView):self.PlaylistView.parent = None
...
"")
        ...
        if(reloadView):
            ...
            self.PlaylistView.parent = self.PlaylistBox
