...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.tile_layout.setColorIdle((0, 0, 0))
        # set tile color during resize
        self.tile_layout.setColorResize((100, 100, 100))
        # set tile color of all tiles during drag and drop
        self.tile_layout.setColorDragAndDrop((100, 100, 100))
        # set tile color of hovered tiles during drag and drop, if empty
        self.tile_layout.setColorEmptyCheck((50, 50, 50))
...
##        )
        ...
        self.tile_layout.setColumnsMinimumWidth(100)
        # set the tiles height
        self.tile_layout.setRowsHeight(100)
        # set the tiles width
        self.tile_layout.setColumnsWidth(100)
