...
"}")
        ...
        self.AlbumImg.setPixmap(QtGui.QPixmap("../../../../media/maxsspeaker/HDD_gamesWin/YandexDisk/python-projects/MSMPstream/uiDevelop/MSMPmax-icon.png"))
...
"QPushButton::down-arrow { image: none; }")
        ...
        self.AudioVisualframe = QtWidgets.QFrame(self.Visualframe)
        self.AudioVisualframe.setGeometry(QtCore.QRect(0, 0, 140, 140))
        self.AudioVisualframe.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.AudioVisualframe.setFrameShadow(QtWidgets.QFrame.Plain)
        self.AudioVisualframe.setObjectName("AudioVisualframe")
