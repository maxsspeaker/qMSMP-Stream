...
"}")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("ui\\img/previous.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("ui\\img/next.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("ui\\img/pause.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("ui\\img/nexttreak.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("ui\\img/Vizual.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("ui\\img/add-open.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("ui\\img/remove.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("ui\\img/menuplaylist.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
